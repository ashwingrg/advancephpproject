...
$dbConnObj->connectToDb('localhost','ashwin','ashwingrg','db_student');
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div id="container">
        ...
        <span class="title" style="font-size:18px; text-decoration:none; margin-top:-20px;">All tables inside db_student database:</span><span><a href="index.php?view=student" style="margin-left:5em; font-weight:bold;">1) tbl_student</a><a href="index.php?view=teacher" style="font-weight:bold; margin-left:5em;">2) tbl_teacher</a></span><br>
		<br>
